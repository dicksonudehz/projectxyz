    ...
    <>
      ...
      <div className="adminDashboardContainer">
        <div className="adminLeftDashboardContainer">
          ...
          <div className="adminDashboardItems">
            <div className="adminDashboardContent">
              ...
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("accountDetails")}>admin profile</h>
            </div>
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><EditLocationAltIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("createProduct")}>create product</h>
            </div>
            
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><DashboardIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("deleteProduct")}>delete product</h>
            </div>
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><PlaylistAddIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("updateProduct")}>update product</h>
            </div>
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><FavoriteIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("myOrders")}>all orders</h>
            </div>
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><EmailIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("message")}>messages</h>
            </div>
            <div className="adminDashboardContent">
              <span className="adminDashboardIcon"><EmailIcon /></span>
              <h className="adminDashboardContentTitle" onClick={() => navigatePage("nomessage")}>no message</h>
            </div>
          </div>
        </div>
        <div className="adminRightDashboardContainer">
          ...
          {/* {activeSection === 'newProduct' ? <NewProduct/> : setActiveSection} */}
